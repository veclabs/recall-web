...
<Note>
  Shadow Drive persistence is currently in development. During alpha, vectors
  are held in the in-memory HNSW index. The demo resets on server restart. This
  will be resolved before mainnet launch.
</Note>
