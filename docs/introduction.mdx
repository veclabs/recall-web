...
| Memory Inspector (@veclabs/solvec)  | Complete - Phase 6 shipped      |
| Context Retrieval (@veclabs/recall) | Planned - Phase 7               |

<Note>
  Phases 1-6 are complete and stable. @veclabs/solvec is production-ready.
  Context Retrieval (@veclabs/recall, Phase 7) is in development.
</Note>
